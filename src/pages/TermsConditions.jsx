    ...
    return (
        <div className='lg:container px-6 py-3 mb-5 border-2 rounded-lg mt-5 border-gray-400 w-max mx-auto shadow-lg'>
            ...
            <div className='lg:container whitespace-normal mx-auto text-sm font-semibold'>
                ...
                <h1>2.1. If you need to contact us, you can do so by email at nmfuad.bd2010@gmail.com, by phone at +8801819194110, or by visiting our About page at https://test-of-radhuni.web.app/about.</h1>
                ...
                <h1>4.1. The Website and its content, including but not limited to text, graphics, images, logos, and software, are the property of [Your Company Name] or its licensors and are protected by copyright, trademark, and other intellectual property laws.</h1>
