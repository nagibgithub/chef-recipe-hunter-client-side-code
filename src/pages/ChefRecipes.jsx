    ...
    return (
        <div className='login-container'>
            <div className='bg-black bg-opacity-60 pb-10'>
                ...
                <div className='lg:grid lg:grid-cols-3 items-center my-10'>
                    <section className='lg:col-span-1'>
                        <img className='border-4 rounded-full backdrop-blur-3xl h-96 w-96 mx-auto' src={picture} alt="" />
                    </section>
                    <section className='lg:col-span-2 border-2 px-4 py-2 rounded-xl shadow-xl lg:mr-10 backdrop-blur-3xl'>
